...
class SupersonicLauncher(ctk.CTk):
    ...
    def launch_game(self, username):
        try:
            ...
            # 3. Download Performance Mods & CustomSkinLoader
            ...
            # ========================================================
            # 4. CUSTOM SKIN SYSTEM CONFIGURATION INJECTION
            # ========================================================
            self.update_status("Configuring Custom Skins...")
            ...
            # ========================================================
            # 5. CRASH LOGGING FIX (Modified to capture the crash)
            # ========================================================
            ...
            # Starts the process and pipes all output (and errors) to the log file
            subprocess.Popen(command, stdout=log_file, stderr=subprocess.STDOUT)
            
            self.update_status(f"Game Launched! If it fails, check: {log_file_path}")
            
            # Intentionally NOT calling self.destroy() here so you can read the status path
            self.play_button.configure(state="normal")
